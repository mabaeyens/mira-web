...
- [2026-09-05] Deleted the last Tailwind leftovers (`assets/tailwind.css`, `tailwind.config.js`, `tailwind-input.css`); nothing had linked them since `vera/privacy` moved to `style.css` on 2026-08-27.
